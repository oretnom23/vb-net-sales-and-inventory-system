...
Public Class frmPasswordRecovery
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Dim con As New SqlConnection("Data Source=.\SqlExpress; Integrated Security=True; AttachDbFilename=|DataDirectory|\SI_DB.mdf; User Instance=true;")
            con.Open()
            Dim cmd As New SqlCommand("SELECT Password FROM Users Where username = 'admin'", con)
