...
Public Class frmCustomersRecord3
    ...
    Private Sub DataGridView2_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView2.RowHeaderMouseClick
        Try
            ...
            frmCustomer.B_Landmark.Text = dr.Cells(3).Value.ToString()
            frmCustomer.B_State.Text = dr.Cells(5).Value.ToString()
            frmCustomer.B_ZipCode.Text = dr.Cells(6).Value.ToString()
            frmCustomer.S_name.Text = dr.Cells(7).Value.ToString()

            frmCustomer.S_Address.Text = dr.Cells(8).Value.ToString()
            frmCustomer.S_City.Text = dr.Cells(10).Value.ToString()
            frmCustomer.S_Landmark.Text = dr.Cells(9).Value.ToString()
            frmCustomer.S_State.Text = dr.Cells(11).Value.ToString()
            frmCustomer.S_ZipCode.Text = dr.Cells(12).Value.ToString()
            ...
            frmCustomer.txtFaxNo.Text = dr.Cells(16).Value.ToString()
